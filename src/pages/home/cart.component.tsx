...
const CartComponent:React.FC<ComponentProps> = ({ selectedFood, setSelectedFood, }) => {
    return (
        <>
            {/* <IonHeader>
            ...
            <IonContent>
                {
                    selectedFood &&
                        <CartContentComponent food={selectedFood} />
                }
                {
                    selectedFood == null &&
                        <CartEmptyComponent />
...
interface CartContentComponentProps {
    food: Food,
}
const CartContentComponent: React.FC<CartContentComponentProps> = ({ food })=> {
    const sizes = [
    ...
    return (
        <div className="cart_content">
            ...
            {/* image */}
            <div className="cart_content__image_holder">
                <img 
                    src={food.img}
                    className="cart_content__image"
                />
            </div>
            ...
            {/* name */}
            <IonTitle className="cart_content__name">
                { food.name }
                <span className="cart_content__name_2">
                    Pizza
                </span>
            </IonTitle>
            ...
            {/* type */}
            <div className="cart_content__type">
                <IonChip
                    className="app_chip"
                    style={{
                        color: 'white',
            ...
            <div className="cart_content__sizes">
                {
                    sizes.map(size=> {
            ...
            <div className="cart_content__quantity">

                <div className="cart_content__quantity__buttons">
                    <QtyButton 
                        onClick={addQuantity}
                        type="add"
                    />
